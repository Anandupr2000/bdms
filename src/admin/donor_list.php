    ...
    <div id="content">
      <div class="content-wrapper">
        <div class="container-fluid">
          ...
          $offset = ($page - 1) * $limit;
          $count = $offset + 1;
          $sql= "select * from donor_details join users join blood where users.uid=donor_details.uid and donor_details.donor_blood=blood.blood_id LIMIT {$offset},{$limit}";
                  ...
                  while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                      ...
                      <td><?php
                                ...
                                // echo $row['donor_blood'];
                                ?>
                      </td>
                      <td><?php echo $row['donor_address']; ?></td>
                      <td id="he" style="width:100px">
                      <button class="btn btn-primary">
                        <a style="color:white;text-decoration:none" href='delete.php?id=<?php echo $row['donor_id']; ?>'> Delete </a>
                      </button>
                      </td>
                    </tr>
                  <?php } ?>
