...
(1, 'near KSRTC bus stand,Kottayam', 'donar1@gmail.com', '9023217801');
...
(1, 'Anuj', 'anuj@gmail.com', '9923471025', 'I need O+ Blood.', '2023-07-07 10:51:01', 1),
(2, 'anju2', '7901761290', 'anju2@gmail', 'I need O -ve blood', '2023-07-17 13:43:55', 1);
...
INSERT INTO `donor_details` (`donor_id`, `uid`, `donor_number`, `donor_age`, `donor_gender`, `donor_blood`, `donor_address`, `fees`, `hascertificate`) VALUES
(1, 2, '9091358908', 24, 'male', 4, 'Ernakulam', 0, 1),
(2, 3, '9901582965', 23, 'female', 4, 'Alappuzha', 100, 0),
(3, 4, '9903998913', 24, 'male', 1, 'Wayanad', 200, 2),
(4, 5, '941319558', 24, 'male', 3, 'Kannur', 100, 0),
(5, 6, '9033315898', 24, 'male', 4, 'Pathanamthitta', 0, 0),
(6, 7, '9088058900', 24, 'male', 2, 'Malappuram', 0, 0),
(7, 17, '8909127812', 27, 'Male', 8, 'Kasargod', 100, 0),
(8, 23, '8967898976', 23, 'Male', 2, 'Thrissur', 0, 0),
(13, 24, '0884656891', 25, 'Male', 5, 'Kochi', 0, 0);
...
CREATE TABLE `medical_history` (
  ...
  `gudHealth` varchar(10) NOT NULL,
  `bloodDonated` varchar(10) NOT NULL,
  `sickness` varchar(10) NOT NULL,
...
INSERT INTO `medical_history` (`uid`, `gudHealth`, `bloodDonated`, `sickness`, `pregnancy`, `diabetic`, `std`) VALUES
...
CREATE TABLE `messages` (
  `mid` int(11) NOT NULL,
  `senderuid` int(11) DEFAULT NULL,
  `receiveruid` int(11) DEFAULT NULL,
...
INSERT INTO `messages` (`mid`, `senderuid`, `receiveruid`, `message`, `timestamp`, `readed`) VALUES
(1, 17, 3, 'Hello', '2023-07-23 18:11:15', 1),
(2, 3, 17, 'Hai', '2023-07-23 18:11:15', 1),
(3, 17, 3, 'Kui', '2023-07-23 18:11:15', 1),
(4, 17, 3, 'y did u contact', '2023-07-23 18:11:15', 1),
(20, 17, 3, 'HelLo', '2023-07-23 18:11:15', 1),
(21, 17, 3, 'HelLo', '2023-07-23 18:11:15', 1),
(22, 17, 3, 'HEllo', '2023-07-23 18:11:15', 1),
(23, 17, 3, 'HEllo', '2023-07-23 18:11:15', 1),
(24, 17, 3, 'hai', '2023-07-23 18:11:15', 1),
(25, 17, 3, 'HEllo', '2023-07-23 18:11:15', 1),
(26, 17, 3, 'Kui', '2023-07-23 18:11:15', 1),
(27, 17, 3, 'Hai', '2023-07-23 18:11:15', 1),
(28, 17, 3, 'Y did u contact', '2023-07-23 18:11:15', 1),
(29, 17, 3, 'testing', '2023-07-23 18:11:15', 1),
(30, 17, 3, 'tEST', '2023-07-23 18:11:15', 1),
(38, 17, 3, 'Can you donate O+ ?', '2023-07-23 18:11:15', 1),
(42, 17, 2, 'Can you donate O+ ?', '2023-07-23 18:42:31', 1),
(43, 17, 3, 'Hello', '2023-07-23 18:11:15', 1),
(44, 3, 17, 'S am Available ', '2023-07-23 18:11:15', 1),
(45, 17, 3, 'Can you donate O+ ?', '2023-07-23 18:11:15', 1),
(46, 17, 3, 'Can you donate O+ ?', '2023-07-23 18:11:15', 1),
(47, 17, 3, 'Can you donate O+ ?', '2023-07-23 18:11:15', 1),
(48, 17, 6, 'Can you donate O+ ?', '2023-07-23 18:12:21', 1),
(49, 17, 6, 'Can you donate O+ ?', '2023-07-23 18:12:21', 1),
(50, 17, 3, 'Can you donate O+ ?', '2023-07-23 18:11:15', 1),
(51, 17, 3, 'Can you donate O+ ?', '2023-07-23 18:13:11', 1),
(52, 3, 17, 'Sorry, Not available', '2023-07-23 18:41:58', 1),
(53, 17, 6, 'Can you donate O+ ?', '2023-07-24 06:11:43', 0),
(54, 17, 6, 'Can you donate O+ ?', '2023-07-24 06:13:15', 0);
...
INSERT INTO `request` (`messageid`, `status`, `responded`) VALUES
(49, 0, 0),
(50, 0, 1),
(51, 0, 0),
(53, 0, 0),
...
INSERT INTO `users` (`uid`, `uname`, `type`, `email`, `upass`) VALUES
(1, 'admin', 'admin', '', '123'),
(2, 'Adhvaidh Jayesh', 'user', 'adhvaidhjayesh@gmail.com', '123'),
(3, 'Gowri', 'user', 'gowri123@gmail.com', '123'),
(4, 'Manoj Kumar', 'user', 'manojkumar@gmail.com', '123'),
(5, 'Sunil Kumar', 'user', 'sunilkumar@gmail.com', '123'),
(6, 'Dhanesh Anand', 'user', 'dhaneshanand@gmail.com', '123'),
(7, 'Sameer KT', 'user', 'sameerkt@gmail.com', '123'),
(17, 'Logan Paull', 'user', '21mp1820@rit.ac.in', '123'),
(18, 'dummy', 'user', 'dummy2@gm.com', '123'),
(23, 'dummy', 'user', 'dumm@fd.df', '123'),
(24, 'dummy donor', 'user', 'dummy@gmail.com', '123');
...
ALTER TABLE `donor_details`
  ...
  ADD UNIQUE KEY `donor_id` (`donor_id`,`uid`),
  ADD UNIQUE KEY `uid` (`uid`) USING BTREE,
  ADD KEY `donor_blood` (`donor_blood`);
...
--
ALTER TABLE `donor_details`
  MODIFY `donor_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `messages`
--
ALTER TABLE `messages`
  MODIFY `mid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
--
ALTER TABLE `donor_details`
  ADD CONSTRAINT `donor_details_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `users` (`uid`),
  ADD CONSTRAINT `donor_details_ibfk_2` FOREIGN KEY (`donor_blood`) REFERENCES `blood` (`blood_id`);
COMMIT;
